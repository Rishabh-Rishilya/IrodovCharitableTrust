  ...
  return (
    <article className="rounded-lg bg-white p-5 shadow-sm ring-1 ring-primary/10">
      <div className="flex items-start justify-between gap-4">
        <span className="rounded-md bg-accent px-3 py-2 text-center text-sm font-black text-white">{date}</span>
        <span className="rounded-full bg-accent/15 px-3 py-1 text-xs font-bold text-white">{type}</span>
      </div>
