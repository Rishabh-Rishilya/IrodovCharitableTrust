...
export default function TestimonialsCarousel() {
  ...
  return (
    <section className="bg-surface-2 px-5 py-16 sm:px-8" onMouseEnter={() => setPaused(true)} onMouseLeave={() => setPaused(false)}>
        ...
        <div className="mt-8 flex items-center gap-4">
          ...
          <div className="grid flex-1 gap-5 md:grid-cols-3">
            {visible.map(([quote, name, role]) => (
              <article key={name} className="rounded-lg bg-white p-6 shadow-sm ring-1 ring-primary/10">
