    ...
    <form className="space-y-8 rounded-lg bg-white p-6 shadow-sm ring-1 ring-primary/10">
      ...
      <section>
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          <input className="rounded-md border border-primary/15 px-4 py-3" placeholder={isHindi ? "पूरा नाम *" : "Full Name *"} />
          <input className="rounded-md border border-primary/15 px-4 py-3" placeholder={isHindi ? "ईमेल *" : "Email *"} />
          <input className="rounded-md border border-primary/15 px-4 py-3" placeholder={isHindi ? "फोन *" : "Phone *"} />
          <input className="rounded-md border border-primary/15 px-4 py-3" placeholder={isHindi ? "80G कर छूट के लिए पैन नंबर" : "PAN Number for 80G tax exemption certificate"} />
          <textarea className="min-h-24 rounded-md border border-primary/15 px-4 py-3 sm:col-span-2" placeholder={isHindi ? "पता" : "Address"} />
        </div>
      </section>
      <section>
