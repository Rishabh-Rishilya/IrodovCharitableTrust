    ...
    <form className="space-y-8 rounded-lg bg-white p-6 shadow-sm ring-1 ring-primary/10">
      ...
      <section>
        ...
        <div className="mt-5 rounded-lg bg-surface p-5">
          ...
          {tab === "online" && <div><span className="rounded-full bg-surface-2 px-3 py-1 text-xs font-bold text-accent">Coming Soon</span><p className="mt-4 font-bold">Online payment gateway coming soon.</p><div className="mt-4 flex gap-2"><input className="flex-1 rounded-md border px-4 py-3" placeholder="Email" /><button type="button" className="rounded-md bg-accent px-4 py-3 font-bold text-white">Notify Me</button></div></div>}
        </div>
      </section>
    </form>
  );
