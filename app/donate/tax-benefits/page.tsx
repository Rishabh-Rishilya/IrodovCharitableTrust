    ...
    <main>
      ...
      <section className="mx-auto max-w-5xl px-5 py-16 sm:px-8">
        <div className="rounded-lg bg-white p-6 shadow-sm ring-1 ring-border">
          ...
          <p className="mt-4 leading-7 text-[#3D4451]">Donations to eligible charitable institutions may qualify for tax deduction under Section 80G. Donors should provide PAN details to receive the tax exemption certificate.</p>
