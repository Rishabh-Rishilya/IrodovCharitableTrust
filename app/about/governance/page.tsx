    ...
    <main>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:px-8">
        <div className="rounded-lg bg-white p-6 shadow-sm ring-1 ring-border">
          ...
          <p className="mt-4 max-w-3xl leading-7 text-[#3D4451]">The trust deed defines IRODOV&apos;s objectives, governance structure, decision rights, and charitable commitments.</p>
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-2">
          <div>
            ...
            <ol className="mt-5 grid gap-3 text-[#3D4451]">
          ...
          <div>
            ...
            <p className="mt-4 leading-7 text-[#3D4451]">IRODOV maintains documented approvals, periodic review, audit trails, and public reporting for all major program and donation flows.</p>
